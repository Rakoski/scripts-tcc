...
PROJETOS_V17 = [
    ...
    ("apache-hadoop-18",            "apache/hadoop",                    "hadoop",                    "Apache",   "apache"),
    ("apache-doris-19",             "apache/doris",                     "doris",                     "Apache",   "apache"),
    ...
    ("google-open-location-code-16","google/open-location-code",        "open-location-code",        "Google",   "google"),
    ("google-bundletool-17",        "google/bundletool",                "bundletool",                "Google",   "google"),
    ("google-bindiff-18",           "google/bindiff",                   "bindiff",                   "Google",   "google"),
    ("google-copybara-19",          "google/copybara",                  "copybara",                  "Google",   "google"),
    ("google-jimfs-20",             "google/jimfs",                     "jimfs",                     "Google",   "google"),
    ("google-firebase-android-sdk-21","firebase/firebase-android-sdk",  "firebase-android-sdk",      "Google",   "google"),
    # Descentralizado (+10)
    ...
    ("netflix-maestro-10",          "Netflix/maestro",                  "maestro",                   "Netflix",  "descentralizado"),
